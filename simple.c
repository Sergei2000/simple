...
VOID 
EFIAPI
MoveCode(UINT64 video_buf_start)
{
unsigned char core_bin[] = {
  0xfa, 0x31, 0xc0, 0x8e, 0xd8, 0x0f, 0x01, 0x16, 0xd0, 0x10, 0x0f, 0x20,
  ...
  0xc7, 0x00, 0x01, 0x00, 0x00, 0xc6, 0x07, 0x01, 0x48, 0xbf, 0x00, 0x00,
  0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x48, 0x81, 0xc7, 0xa0, 0x86, 0x01,
  0x00, 0x48, 0xc7, 0xc1, 0x00, 0x10, 0x00, 0x00, 0x66, 0xc7, 0x07, 0x44,
  0xe1, 0x48, 0xff, 0xc7, 0x48, 0xff, 0xc7, 0xe2, 0xf3, 0xeb, 0xfe, 0x90,
  0x90, 0x90, 0x90, 0x90, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0xff, 0xff, 0x00, 0x00, 0x00, 0x9a, 0xcf, 0x00, 0xff, 0xff, 0x00, 0x00,
  0x00, 0x96, 0xcf, 0x00, 0x17, 0x00, 0xb8, 0x10, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
unsigned int core_bin_len = 222;


  core_bin[core_bin_len-1]=(video_buf_start>>(64-8))&0xff;
  core_bin[core_bin_len-2]=(video_buf_start>>(64-16))&0xff;
  core_bin[core_bin_len-3]=(video_buf_start>>(64-24))&0xff;
  core_bin[core_bin_len-4]=(video_buf_start>>(64-32))&0xff;
  core_bin[core_bin_len-5]=(video_buf_start>>(64-40))&0xff;
  core_bin[core_bin_len-6]=(video_buf_start>>(64-48))&0xff;
  core_bin[core_bin_len-7]=(video_buf_start>>(64-56))&0xff;
  core_bin[core_bin_len-8]=(video_buf_start>>(64-64))&0xff;
